...
export const DashBoard = () => {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#1C1C1E] text-white">
      <div className="flex h-full min-h-screen p-6">
        ...
        <div className="flex flex-col flex-1 min-h-0">
          ...
          <div className="flex-1 flex justify-center">
            <div className="w-full max-w-3xl bg-[#2C2C2E] rounded-xl p-6 overflow-y-auto text-base mx-auto">
              {renderContent()}
            </div>
          </div>
        </div>

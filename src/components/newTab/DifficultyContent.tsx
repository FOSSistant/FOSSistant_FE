      ...
      <div className="group bg-gradient-to-br from-purple-500/15 to-indigo-600/15 rounded-xl p-5 border border-purple-500/30 hover:border-purple-400/50 transition-all duration-300 hover:scale-[1.02]">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-3">
              개발 난이도와 무관한 이슈입니다. 기능 요청, 질문, 토론 등이 해당됩니다.
            </p>
            <div className="bg-purple-500/10 rounded-lg p-3 border border-purple-500/20">
              <p className="text-xs text-gray-400 mb-2 font-semibold">예시:</p>
              <div className="flex flex-wrap gap-1">
                <span className="px-2 py-1 bg-purple-500/20 text-purple-200 text-xs rounded-full">기능 요청</span>
                <span className="px-2 py-1 bg-purple-500/20 text-purple-200 text-xs rounded-full">질문/토론</span>
                <span className="px-2 py-1 bg-purple-500/20 text-purple-200 text-xs rounded-full">문서화 요청</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="group bg-gradient-to-br from-gray-500/15 to-slate-600/15 rounded-xl p-5 border border-gray-500/30 hover:border-gray-400/50 transition-all duration-300 hover:scale-[1.02]">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-3">
              AI 모델이 분류에 확신을 가지지 못할 때 사용됩니다. 정보가 부족하거나 애매한 경우입니다.
            </p>
            <div className="bg-gray-500/10 rounded-lg p-3 border border-gray-500/20">
              <p className="text-xs text-gray-400 mb-2 font-semibold">예시:</p>
              <div className="flex flex-wrap gap-1">
                <span className="px-2 py-1 bg-gray-500/20 text-gray-200 text-xs rounded-full">정보 부족</span>
                <span className="px-2 py-1 bg-gray-500/20 text-gray-200 text-xs rounded-full">모델 분류 실패</span>
                <span className="px-2 py-1 bg-gray-500/20 text-gray-200 text-xs rounded-full">분석 필요</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="bg-gradient-to-br from-blue-500/10 to-purple-600/10 rounded-xl p-5 border border-blue-500/30">
      <div>
        ...
        <ul className="space-y-2 text-gray-300">
          ...
          <li className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 bg-blue-400 rounded-full mt-2 shrink-0"></span>
            <span className="text-sm">난이도와 무관한 이슈인 <strong className="text-purple-300">📌 misc</strong>는 프로젝트 이해도 향상에 도움이 됩니다</span>
          </li>
        </ul>
      </div>
    </div>

export const IssueList = () => {
  return (
    ...
    >
      <h1 className="text-lg font-bold text-white mb-2">이슈 난이도 분류 기준</h1>

      <div className="space-y-2 text-xs">
        {/* 상 */}
        <div className="bg-[#2c2c2c] border border-[#444] rounded-md p-3">
          <h2 className="text-sm font-semibold text-red-400">상 🔥</h2>
        ...
        {/* 중 */}
        <div className="bg-[#2c2c2c] border border-[#444] rounded-md p-3">
          <h2 className="text-sm font-semibold text-yellow-400">중 ⚙️</h2>
          <p className="text-[#bbbbbb] mt-1">
        ...
        {/* 하 */}
        <div className="bg-[#2c2c2c] border border-[#444] rounded-md p-3">
          <h2 className="text-sm font-semibold text-green-400">하 🧩</h2>
          <p className="text-[#bbbbbb] mt-1">
        ...
        {/* 알 수 없음 */}
        <div className="bg-[#2c2c2c] border border-[#444] rounded-md p-3">
          <h2 className="text-sm font-semibold text-gray-400">알 수 없음 ❓</h2>
          <p className="text-[#bbbbbb] mt-1">
